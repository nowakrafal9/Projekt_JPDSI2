...
START TRANSACTION;
USE `biblioteka_JPDSI2`;
INSERT INTO `biblioteka_JPDSI2`.`borrower` (`idBorrower`, `borrowerCode`, `name`, `surname`, `city`, `postalCode`, `address`, `phoneNum`, `email`, `status`) VALUES (DEFAULT, '0001', 'Damian', 'Okański', 'Sosnowiec', '41-200', 'ul. Okańska 12', '556434343', NULL, 1);
INSERT INTO `biblioteka_JPDSI2`.`borrower` (`idBorrower`, `borrowerCode`, `name`, `surname`, `city`, `postalCode`, `address`, `phoneNum`, `email`, `status`) VALUES (DEFAULT, '0002', 'Paweł', 'Wałęsak', 'Sosnowiec', '41-200', 'ul. Włóczęgów 14/4', '767454354', 'wales@wp.pl', 1);
INSERT INTO `biblioteka_JPDSI2`.`borrower` (`idBorrower`, `borrowerCode`, `name`, `surname`, `city`, `postalCode`, `address`, `phoneNum`, `email`, `status`) VALUES (DEFAULT, '0003', 'Piotr', 'Mały', 'Sosnowiec', '41-200', 'ul. Maleńskiego 1', '545443323', 'jakismail@onet.pl', 1);
